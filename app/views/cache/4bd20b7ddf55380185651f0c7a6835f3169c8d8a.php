...
<body>
    ...
    <form action="../controllers/validar_modificarTarea.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
        <h2>Modificar tarea <?= $id ?> </h2>
...
<?php echo $__env->make('_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP\Proyecto\app\views/formulario_modificarTarea.blade.php ENDPATH**/ ?>